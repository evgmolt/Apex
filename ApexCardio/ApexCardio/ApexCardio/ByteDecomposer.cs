...
namespace ApexCardio
{
    public class DataArrays
    {
        ...
        public double[] FragECG1;
        public double[] FragECG2;
        public double[] FragReo1;
        public double[] FragReo2;
        public double[] FragSphigmo1;
        public double[] FragSphigmo2;
        public double[] FragApex;

        public List<double[]> FragList;
    ...
    public DataArrays(int size)
        {
            ...
            FragECG1 = new double[size];
            FragECG2 = new double[size];
            FragReo1 = new double[size];
            FragReo2 = new double[size];
            FragSphigmo1 = new double[size];
            FragSphigmo2 = new double[size];
            FragApex = new double[size];

            FragList = new List<double[]>();
            FragList.Add(FragECG1);
            FragList.Add(FragECG2);
            FragList.Add(FragReo1);
            FragList.Add(FragReo2);
            FragList.Add(FragSphigmo1);
            FragList.Add(FragSphigmo2);
            FragList.Add(FragApex);

            FirstDerivReo1 = new double[size];
            FirstDerivReo2 = new double[size];
            FirstDerivSphigmo1 = new double[size];
            FirstDerivSphigmo2 = new double[size];
            FirstDerivApex = new double[size];
            ...
            SecDerivReo1 = new double[size];
            SecDerivReo2 = new double[size];
            SecDerivSphigmo1 = new double[size];
            SecDerivSphigmo2 = new double[size];
            SecDerivApex = new double[size];
